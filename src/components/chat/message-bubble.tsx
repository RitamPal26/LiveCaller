      ...
      <Popover>
        ...
        >
          <PopoverTrigger asChild>
            <div
              className={`rounded-lg px-4 py-2 break-words whitespace-pre-wrap cursor-pointer ${
                msg.isDeleted
        ...
        {!msg.isDeleted && (
          <PopoverContent
            className="w-auto p-1 bg-slate-800 border-slate-700 rounded-full shadow-lg flex items-center gap-1"
            side="top"
